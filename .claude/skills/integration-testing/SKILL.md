...
description: >-
  ...
  backends before it lands: the per-PR pipeline, gate discipline, model-tiered
  multi-agent review, live-testing discipline, and an operator-gated disposition
  rule. The HOW that the agw-test-env skill (the WHERE) defers to.
---
# Integration Testing
