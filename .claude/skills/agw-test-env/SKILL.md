...
name: agw-test-env
description: >-
  The agentworks live integration-test environment on this host: inventory,
  naming, budgets, and safety protocol. Load before invoking agentworks-tester
  agents or doing any live testing, and inject the relevant sections into each
  tester's prompt.
---
