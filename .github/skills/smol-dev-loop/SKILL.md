...
name: smol-dev-loop
description: >-
  The autonomous issue-to-mergeable-PR loop: scan smol-dev issues, vet them,
  drive each through the standard development process, cycle the PR to green,
  and hand it back for the operator to merge
---
# Smol Dev Loop
