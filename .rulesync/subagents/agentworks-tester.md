...
targets: ["*"]
description: >-
  Exercises the real agentworks CLI against live backends and reports findings from observed
  behavior. Invoke with a scoped charter, an environment inventory, and a resource budget. Does not
  fix anything; produces an evidence-backed report and leaves no residue.
claudecode:
  model: inherit
---
