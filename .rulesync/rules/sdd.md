...
- `hla.md` (High-Level Architecture): A markdown file that describes the high-level architecture.
  ...
  choices, integration with the Gruntweave platform, etc. This generally shouldn't have low-level
  details such as code samples, specific versions, etc. unless they are critical to the
