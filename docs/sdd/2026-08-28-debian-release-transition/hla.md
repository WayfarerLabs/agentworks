...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lima     | The live instance's driver selects the primitive. QEMU uses `limactl snapshot create/list/apply/delete`. VZ uses a stopped, protected `limactl clone`; restore clones a temporary instance, retains the exact original pre-first-restore directory under a protected emergency name, and uses an exclusive local OS rename or standard SFTP exact-path rename to move the recovered sibling directory back to the original name without copy fallback. The checkpoint clone records the stable restore operation identity for replay. Delete validates and removes every related recovery instance. VZ refuses `additionalDisks`. |
