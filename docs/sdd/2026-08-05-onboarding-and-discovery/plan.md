...
The three completed review rounds above remain as historical execution records. The operator scope
correction below subsequently removed the database-copying subsystem they exercised.
