...
- **The combined `EnvEntry` model is retired** by the variant-modeling rework (PR #455, merged
  2026-08-08): env entries are a structural plaintext-or-secret union, and the
