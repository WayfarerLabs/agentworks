...
carries the deletable scaffolding means the rewrite carries it too, so the pass's waves land first.
Its wave 0 leads in turn, because establishing that always-on rules actually reach the agents they
bind (issue #511) has to precede adding deletion criteria to those rules.
