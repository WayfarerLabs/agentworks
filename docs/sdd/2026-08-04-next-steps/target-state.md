...
(`docs/sdd/2026-08-07-installer-plugins/`). The core keeps only what is essential to what a VM is.
An existing config referencing a moved surface without the owning plugin enabled fails with a crisp
