...
- [x] Phase 1 (guide core, safe projection, verification surfaces) reviewed: three-pass roadmap
      ...
      execution and approved (2026-08-08); all mutations pinned, gates green
- [x] Merge order ruled (operator, 2026-08-08, confirming the effort's D7): wave 2 merges first,
...
- [ ] Phase 1 merged (after wave 2 lands and the rebase clears re-check)
