...
the config each capability implementation OFFERS, chosen by its consumers (section 7).
...
the capability gained nothing from knowing who was asking. It was also strictly more dynamic than
