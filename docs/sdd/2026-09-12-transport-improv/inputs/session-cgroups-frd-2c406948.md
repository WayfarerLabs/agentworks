# Session-cgroups requirement source snapshot

- Source: PR #770, `2c406948221a8990192e581a68f25802615e3ac5`,
  `docs/sdd/2026-09-06-session-cgroups/frd.md`.
- Captured: 2026-09-19 UTC for transport design reconciliation.
- Status: Verbatim review input, not adopted transport requirements or operator direction.

This preserves the full source, including its threat model, acceptance cases, exclusions and
rulings, if the draft branch changes. The lifecycle routing index is not a substitute for it. The
session effort retains its charter until explicit operator disposition. At an authorized transfer,
reconcile the then-current source and carry accepted requirements into their designated home before
retiring either record. Do not maintain this snapshot as a second evolving FRD.
