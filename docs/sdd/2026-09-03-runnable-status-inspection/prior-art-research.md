...
### 7. Non-interactive Windows SSH needs finite stdin
...
eight concurrent console probes timed out after receiving complete newline-terminated stdout and no
stderr; with empty finite stdin, 80 of 80 otherwise-identical concurrent probes completed. This
