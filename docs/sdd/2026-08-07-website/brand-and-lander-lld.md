...
| `website/templates/404.html`                | Semantic 404 template with the closed site-base placeholder     |
...
| R7, D7: useful static 404, hidden reveal, Space and activation start                  | Sections 4, 6, and 10.1        |
