#!/usr/bin/env bash
# Example harness: BREAKING-CHANGE loader drive.
#
...
#
# This example drives config.toml's ADR-0022 resource-section sunset:
...
# fixture and the assertion to whatever breaking change you are verifying.
set -euo pipefail
