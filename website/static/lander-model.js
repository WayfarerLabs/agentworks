...
const ROUTES = [
    ...
    ["route-93-flat",93,0,[[4.8,-0.65],[46.5,-0.65],[88.2,-0.65]],8.15,1498651857,[[1,90],[0,1],[1,27],[0,7],[2,15],[5,4],[3,44],[0,160],[2,21],[0,352],[2,30],[1,82],[0,250],[1,76],[0,259],[1,100],[0,497],[1,81],[2,16],[5,1],[1,54],[4,2],[0,493],[1,81],[3,46],[4,1],[3,36],[4,49]],2875,8.121999999999856,91.590782713,0.269134094,1.608662298,-1.223992666,-9.683765214,5.733285716,2872,91.562983183,0.290173104,1.699073271,-1.281241753],
...
const FAILURE_LITERALS = [
    [8,8.000000000000018,-9.375629389,12.57275481],
    [8.1,8.100000000000005,-9.783560214,6.322201732],
    [8.15,8.150000000000016,-6.377854246,-8.305060918],
];
...
export function updateRetention(model) {
    ...
    const cameraLeft = cameraForPose(model.pose).left;
