...
class TemplateContractTests(RepositoryFixture):
    ...
    def test_onboarding_paths_copy_icon_and_shared_destinations_are_guarded(
        ...
        variants = (
            ...
            template.replace('data-panel="manual-panel"', 'data-panel="other-panel"'),
            template.replace('id="via-agent-panel"', 'id="other-agent-panel"'),
            template.replace('id="manual-panel"', 'id="other-manual-panel"'),
