...
class StaticDocumentTests(unittest.TestCase):
    ...
    def test_scene_geometry_and_start_target_are_fixed_and_responsive(self) -> None:
        ...
        self.assertIn((312, 473.7969696969697), surface)
        self.assertIn((322, 473.6309343434343), surface)
        self.assertIn((400, 473.73055555555555), surface)
        self.assertIn((410, 473.91319444444446), surface)
        self.assertIn((488, 482.6528819444444), surface)
        self.assertIn((498, 484.6063541666667), surface)
        ...
        self.assertEqual(support["d"].count("M"), 43)
