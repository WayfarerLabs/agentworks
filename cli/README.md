...
| Command                                | Description                         |
| -------------------------------------- | ----------------------------------- |
| `agentworks workspace create`          | Create a workspace on a VM          |
...
| `agentworks workspace copy <source>`   | Copy a workspace to a new VM        |
...
`workspace create` accepts `--name`, `--vm`, `--template`, and `--open-vscode`.
...
`workspace copy` copies a workspace to a new VM workspace. Accepts `--name` and `--vm`. Source and
destination can be the same VM (a clone) or different VMs.
