...
small fenced passages can appear only in agent mode. Use `agw guide --names-only` when a completion
or tool needs every installed concept and packaged release-note topic name.
