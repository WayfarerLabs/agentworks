...
from agentworks.execution.diagnostics import ExecutionPhase, check_execution_result
...
def check_owned_inline_result(
    ...
    *,
    ...
    return check_execution_result(
        ...
        phase=_inline_phase_refinement(outcome, result),
    )
