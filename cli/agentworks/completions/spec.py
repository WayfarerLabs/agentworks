...
DYNAMIC_COMPLETIONS: dict[tuple[str, str], str] = {
    ...
    ("session.list", "harness_integration"): "harness_integrations",
    ("session.stop", "name"): "sessions",
    ("session.stop", "vm"): "vms",
    ("session.stop", "workspace"): "workspaces",
    ("session.stop", "agent"): "agents",
    ("session.stop", "harness_integration"): "harness_integrations",
    ("session.stop", "console"): "consoles",
    ("session.start", "name"): "sessions",
    ("session.start", "vm"): "vms",
    ("session.start", "workspace"): "workspaces",
    ("session.start", "agent"): "agents",
    ("session.start", "harness_integration"): "harness_integrations",
    ("session.start", "console"): "consoles",
    ("session.restart", "name"): "sessions",
    ("session.restart", "vm"): "vms",
    ("session.restart", "workspace"): "workspaces",
    ("session.restart", "agent"): "agents",
    ("session.restart", "harness_integration"): "harness_integrations",
    ("session.restart", "console"): "consoles",
    ("session.attach", "name"): "sessions",
    ("session.delete", "name"): "sessions",
    ("session.logs", "name"): "sessions",
    # Env inspection
    ("artifact.show", "integration"): "harness_integrations",
    ("artifact.show", "vm"): "vms",
    ("artifact.show", "workspace"): "workspaces",
    ("artifact.show", "agent"): "agents",
    ("artifact.show", "session"): "sessions",
    ("env.show", "vm"): "vms",
