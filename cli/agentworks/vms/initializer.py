...
def initialize_vm(
    ...
    *,
    ...
    ``hold_active`` is the keepalive span built at ``create_vm``'s
    composition root (``platform.vm_active``), anchoring the VM active
    for the whole init; ``platform`` still rides along for the WSL2 swap
    check below.
    """
