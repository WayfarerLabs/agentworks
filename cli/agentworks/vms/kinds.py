...
class _VMTemplateKind:
    ...
    def resolve_for_show(self, registry: Registry, name: str) -> ResolvedSpec:
        """Resolve one concrete VM template for focused inspection."""
...
class _AdminTemplateKind:
    ...
    def resolve_for_show(self, registry: Registry, name: str) -> ResolvedSpec:
        """Resolve one concrete admin template for focused inspection."""
        from agentworks.resources.access import ResourceIdentity
        from agentworks.resources.resolved_spec import project_resolved_spec
        from agentworks.vms.admin_templates import resolve_template_with_provenance
