...
_LATCHED_HEAL_HINT = (
    ...
    "forwarder (issue #117 latched state). Open a provisioner shell\n"
    "(which uses the platform-native transport, NOT Tailscale, so the\n"
    "heal sequence survives stopping tailscaled):\n"
    "\n"
    "    agw vm shell --provisioner <vm-name>\n"
    "\n"
    "Then in that shell:\n"
    "\n"
