...
_LATCHED_HEAL_HINT = (
    ...
    "opens a firewall allow scoped to your public IP for the session\n"
    "and removes it on exit (see operator.ssh_allow_cidrs in the config\n"
    "if your SSH traffic egresses through a different address).\n"
