...
slice with effective declaration fingerprints and lossless normalized content. Inactive integrations
reuse that common capture without acquiring their own applied record.
