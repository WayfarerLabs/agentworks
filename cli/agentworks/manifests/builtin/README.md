...
reserved vm-sites (`vm-sites.yaml`). Optional apt and user install-command catalog rows belong to
their opt-in system plugins. Future built-ins and plugins (their own origin variants) are the
