...
(the operator's YAML manifests, the bundled built-in manifests, the
capability-row publishers, future plugins) push composed Resources into it;
``Registry.finalize()`` runs the framework pass that walks
