...
Prepare the smallest reproducible command, expected result, observed framed error, and relevant
version information. Remove credentials, secret values, personal paths, hostnames, and unrelated
configuration. Report only reproducible Agentworks bugs; feature ideas, questions, and general
feedback do not belong in the bug workflow.
