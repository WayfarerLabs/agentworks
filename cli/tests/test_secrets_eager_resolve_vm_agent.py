...
def test_vm_create_does_not_eager_resolve_operator_env() -> None:
    ...
    from agentworks.git_credentials import nodes as credential_nodes
    ...
    sources = [
        ...
        inspect.getsource(credential_nodes.git_credential_node),
...
def test_vm_shell_env_target_joins_the_bind_boundary(
    ...
    with pytest.raises(_Stop):
        vm_manager.shell_vm(db, config, "vm1", interaction=TtyInteractionPolicy.REFUSE)  # type: ignore[arg-type]
