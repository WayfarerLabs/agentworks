...
def test_git_token_sample_shows_the_secret_union_and_its_scalar_spelling() -> None:
    ...
    assert lines[at - 1] == "#    # One of: secret. Shown here: secret."
    assert "#      # mode: secret" in lines
