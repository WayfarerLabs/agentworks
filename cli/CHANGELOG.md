...
* add scoped agent artifacts ([908258a](https://github.com/WayfarerLabs/agentworks/commit/908258a932c7715ff92dc75a7a64163a99920872))
* **artifacts:** capture complete packages and encode normalized inputs ([8f309ac](https://github.com/WayfarerLabs/agentworks/commit/8f309ac43bcfb9925aa604d7e565fe0c9a11caa1))
* **artifacts:** capture owning scopes and apply integration results ([8193b30](https://github.com/WayfarerLabs/agentworks/commit/8193b309c6ff72ac9d5651dda6d9b0e4f77cbea0))
* **artifacts:** declare bundles and scoped selections ([e97e9cd](https://github.com/WayfarerLabs/agentworks/commit/e97e9cdbefe1195822632d299d26ef54bf420982))
* **artifacts:** define immutable normalized input model ([1155fe3](https://github.com/WayfarerLabs/agentworks/commit/1155fe3c9b44cbc99b22cebc3628ec8f6648dc35))
* **artifacts:** define native delivery and prepared session contracts ([de411c2](https://github.com/WayfarerLabs/agentworks/commit/de411c21cad913b94edf3a6ec3446f5095ce8631))
* **artifacts:** inspect scoped delivery and document setup ([93ba5bd](https://github.com/WayfarerLabs/agentworks/commit/93ba5bdf38fd1c8fde9e831e2ecf7e263cf85830))
* **artifacts:** model generated sections and publication skips ([42c780a](https://github.com/WayfarerLabs/agentworks/commit/42c780aecfae8cc789e4d085a668d34d581da85a))
* **artifacts:** persist core capture snapshots by owner component ([be1f0d7](https://github.com/WayfarerLabs/agentworks/commit/be1f0d7f3c0f9f4d615388d04a56e11f88edf9e8))
* **artifacts:** prepare and publish private session runs ([d62911e](https://github.com/WayfarerLabs/agentworks/commit/d62911e403344fc8d9ac1c3e270b7c0c33548e6c))
* **artifacts:** publish owned files through core applied state ([effa594](https://github.com/WayfarerLabs/agentworks/commit/effa59452beb86e35b8befdf30a9c954556db29b))
* **artifacts:** render scoped native delivery plans ([951f218](https://github.com/WayfarerLabs/agentworks/commit/951f218412ff478eff3b00d4be3d565542667830))
* **artifacts:** report scoped delivery and document native placement ([5d5b216](https://github.com/WayfarerLabs/agentworks/commit/5d5b21661fd06025c089c63348551a1e8dadcdf4))
* **artifacts:** route captured inputs through actual owner facets ([d260100](https://github.com/WayfarerLabs/agentworks/commit/d2601004ac0cbe0188c52c901fa05d74f9b2b07f))
* **artifacts:** share session routing order with inspection ([49ccab2](https://github.com/WayfarerLabs/agentworks/commit/49ccab267a796e586904d7af907f56e774614b0f))
...
* **db:** persist session and managed run identities ([d7c2fc8](https://github.com/WayfarerLabs/agentworks/commit/d7c2fc8dbbb23353cd5e62f028b54b847ecb897a))
...
* **harness:** resolve facet activation maps by integration key ([7b2e464](https://github.com/WayfarerLabs/agentworks/commit/7b2e4641b2b895aa9ff03dc7684e5e96e790d4f4))
...
* preserve artifact type maps and original owner groups ([cdf87c0](https://github.com/WayfarerLabs/agentworks/commit/cdf87c0e6b7f114e152aea6bc11989f910715285))
...
* **session:** filter batches by harness integration ([42d761b](https://github.com/WayfarerLabs/agentworks/commit/42d761b0b09d559a6ab646e765309e09cb7f797d))
...
* **artifacts:** anchor workstation capture traversal ([6a54464](https://github.com/WayfarerLabs/agentworks/commit/6a54464f4cae9ca149903938634fa3b104dbf9aa))
* **artifacts:** apply at native scopes and report delivery ([91902c0](https://github.com/WayfarerLabs/agentworks/commit/91902c016169e8e81474902bfab712a6a8892dbf))
* **artifacts:** apply native artifacts at their defining scope ([405dc1e](https://github.com/WayfarerLabs/agentworks/commit/405dc1e008d41bcab5d01583edae830700e9afe1))
* **artifacts:** bound elevated native file access ([66f0edb](https://github.com/WayfarerLabs/agentworks/commit/66f0edb54bef5a758e6c7a8bf0ca7947cf7aec2f))
* **artifacts:** check existing ancestors when session owners are pending ([cd92efd](https://github.com/WayfarerLabs/agentworks/commit/cd92efd3648addba64f352bf1190839b624920f4))
* **artifacts:** enforce supported native placement before setup ([5142b19](https://github.com/WayfarerLabs/agentworks/commit/5142b19b452440134ef8e09931539ac20ab26f2b))
* **artifacts:** guard deletion and reject stale ancestors before secrets ([380371f](https://github.com/WayfarerLabs/agentworks/commit/380371fe671b2ab233e12e0af15057c1aeb60d1a))
* **artifacts:** include session captures in scoped VM backups ([e76c643](https://github.com/WayfarerLabs/agentworks/commit/e76c643a8db2aac66baca7fac717fd2639329562))
* **artifacts:** narrow setup dispatch to outer facets ([197cd21](https://github.com/WayfarerLabs/agentworks/commit/197cd21aedb22d72b2b398ffa3ed3a1edfedd019))
* **artifacts:** parse rule frontmatter and reject unsupported metadata ([45a5ab4](https://github.com/WayfarerLabs/agentworks/commit/45a5ab452197cc434d0662ac902c99107aede930))
* **artifacts:** prepare inputs before setup mutation checkpoint ([bca7e4a](https://github.com/WayfarerLabs/agentworks/commit/bca7e4aab948c5a7c3b933ef32cca50ef169a7a7))
* **artifacts:** preserve guidance across selective workarounds ([aadffb5](https://github.com/WayfarerLabs/agentworks/commit/aadffb585852b912eac022bd54f6233ec11e4469))
* **artifacts:** preserve section metadata and ownership boundaries ([0decc2a](https://github.com/WayfarerLabs/agentworks/commit/0decc2a75deb2c0531543fd5affcc206c8ca3806))
* **artifacts:** publish native sections and VM artifacts safely ([3b3b9f6](https://github.com/WayfarerLabs/agentworks/commit/3b3b9f69c35050782aafb3b3f247e3da0e9ed0fb))
* **artifacts:** redact diagnostics before trimming whitespace ([5b51afc](https://github.com/WayfarerLabs/agentworks/commit/5b51afcab1aa3e9a9291051bd046df90a2398960))
* **artifacts:** redact runtime values from probe diagnostics ([15b7144](https://github.com/WayfarerLabs/agentworks/commit/15b7144800dcd8a698cb298d10afaaf5cf134233))
* **artifacts:** report handled inputs including launch arguments ([0179eee](https://github.com/WayfarerLabs/agentworks/commit/0179eee5e48fc8b8941ef3365b19e8f7930e5313))
* **artifacts:** require explicit native session workarounds ([21a9b4b](https://github.com/WayfarerLabs/agentworks/commit/21a9b4b7d9eb4254e4e382f87e261fd55482b987))
* **artifacts:** require opt-in session workarounds ([b00b39b](https://github.com/WayfarerLabs/agentworks/commit/b00b39bec241630a249f3f279a824d5c78e2dae3))
* **artifacts:** size encoded snapshots for lossless content ([afa0278](https://github.com/WayfarerLabs/agentworks/commit/afa027823693e6cd307f57324a930d7d793b253b))
* **artifacts:** traverse ancestors without requiring listing access ([784f53a](https://github.com/WayfarerLabs/agentworks/commit/784f53a06a917c9e7714ff3e6aec76e5ba975900))
* **artifacts:** validate native discovery and launch carriers ([3b4ea08](https://github.com/WayfarerLabs/agentworks/commit/3b4ea08b6602233be99c4d321bad6122af3fb698))
* **artifacts:** validate persisted entrypoint semantics ([832e257](https://github.com/WayfarerLabs/agentworks/commit/832e257407aeea00ce49c3a024bb6b69ba5176cf))
* **artifacts:** validate provenance before storing captured inputs ([53bd6ec](https://github.com/WayfarerLabs/agentworks/commit/53bd6eca49996fcdec593722ec16cae574d8aa57))
* **artifacts:** validate rule and agent frontmatter ([adc2d3e](https://github.com/WayfarerLabs/agentworks/commit/adc2d3e06cb54efd4271a03d70d9dfc9e61f8097))
* **artifacts:** verify owned modes without copying existing content ([4f4ab01](https://github.com/WayfarerLabs/agentworks/commit/4f4ab01ee0e66280b6b341a3fe4db537cecc927c))
* **artifacts:** warn on unhandled session inputs and gate shell files ([cf29719](https://github.com/WayfarerLabs/agentworks/commit/cf297199cda068b016f7e1e9c3a1921aa58484af))
* bound recursive Codex skill discovery before publication ([16c40a2](https://github.com/WayfarerLabs/agentworks/commit/16c40a24e91e236eeae440f13553bf8fb84cae9f))
* clarify artifact handling reports and inspection status ([a8cb7d9](https://github.com/WayfarerLabs/agentworks/commit/a8cb7d98fd322e6edd7ce7923ca089ca4567b639))
...
* **cli:** confirm running session restarts ([999f75f](https://github.com/WayfarerLabs/agentworks/commit/999f75f2f3e76826104abcd1f20fc0f3de6de784))
* **cli:** confirm running session restarts ([457f375](https://github.com/WayfarerLabs/agentworks/commit/457f3755b53b28ffea3d9878a1f2ff9e9b7bb6b4))
...
* **cli:** render hints from the causes an error wraps ([15001a1](https://github.com/WayfarerLabs/agentworks/commit/15001a13c4004ba20b33b9b1c123ec07a3fb83b3))
...
* **cli:** use singular artifact command group ([b2df951](https://github.com/WayfarerLabs/agentworks/commit/b2df951df35ba1f78f752e39476d442b180aae20))
* **cli:** use singular artifact command group ([bdc2c35](https://github.com/WayfarerLabs/agentworks/commit/bdc2c3508d87ef9eb716d84755572ecf7acdf273))
...
* enforce artifact capture boundaries consistently ([cfb4c75](https://github.com/WayfarerLabs/agentworks/commit/cfb4c7599c8bbc2b49b02e3befe5046dc52fff9c))
* explain when deferred artifacts reach later scopes ([6f3e09c](https://github.com/WayfarerLabs/agentworks/commit/6f3e09cd89dd522591b30f8206c092d2ec538d78))
* **guide:** accept mode flags on subcommands ([a0aa310](https://github.com/WayfarerLabs/agentworks/commit/a0aa31091c86e8feda0a68b8c2c64e5dc0f32bc3))
* **guide:** accept mode flags on subcommands ([5d6b2f6](https://github.com/WayfarerLabs/agentworks/commit/5d6b2f68afa3110606c04b3e2b852938090732a2))
* **guide:** clarify list mode option help ([fe97dcf](https://github.com/WayfarerLabs/agentworks/commit/fe97dcf6ec43c048b9e4d3a41a6fb3cc2a594bf5))
* **guide:** follow canonical shell boundaries ([a1e435b](https://github.com/WayfarerLabs/agentworks/commit/a1e435b9ac3c30dc30c5f0547c264841b0bcbe42))
* **guide:** keep inline spans non-overlapping ([16037c1](https://github.com/WayfarerLabs/agentworks/commit/16037c16b5a13dd6baffeadaf9034a7541427ee4))
* **guide:** keep shell context authoritative ([656bac1](https://github.com/WayfarerLabs/agentworks/commit/656bac18851f80c24632846bcc821a10a0b3e0d1))
* **guide:** validate compound command references ([4ef3046](https://github.com/WayfarerLabs/agentworks/commit/4ef30460f06bfd0a55d95e1e5cfeeb6c3ef9be8b))
...
* **harness:** align native merge guidance and simplify map schema ([4057c3f](https://github.com/WayfarerLabs/agentworks/commit/4057c3fbc6aecab5f4b90f713f20856c56eddc33))
* **harness:** carry activation maps through setup and saved state ([923b522](https://github.com/WayfarerLabs/agentworks/commit/923b5226b1ef8291b178389fb5cb68216f5de4f7))
* **harness:** carry activation opt-outs through instance state ([875f7bf](https://github.com/WayfarerLabs/agentworks/commit/875f7bf1a30c8fba24abf40d79ea20a6a07f6c55))
...
* **harness:** name the path and cause when native setup refuses a file ([a2eaba1](https://github.com/WayfarerLabs/agentworks/commit/a2eaba12e321f7b831aca8332e11b42a57b84346))
* **harness:** preserve inherited integration activations with maps ([a22d5cb](https://github.com/WayfarerLabs/agentworks/commit/a22d5cb6b73b03d116335dc3a732685d0e6289ae))
...
* **harness:** preserve schema keys and reference traversal boundaries ([6324deb](https://github.com/WayfarerLabs/agentworks/commit/6324debabbfbb50d3ba057fcc9fb430c19f707e8))
...
* **harness:** retain session selectors and apply setup opt-outs ([5d1e317](https://github.com/WayfarerLabs/agentworks/commit/5d1e317488d12f360657b52c9e2d16cc14e2e2cc))
* **harness:** validate saved state before map migration recovery ([045cb7b](https://github.com/WayfarerLabs/agentworks/commit/045cb7b4bd59c8bdf78c9587703b6ce569df9f09))
* keep native artifact retirement and inventory bounds consistent ([55ff7ae](https://github.com/WayfarerLabs/agentworks/commit/55ff7aee30d0d012a02e6de3a95f9effa89e09a5))
...
* preserve artifact lifecycle and declaration boundaries ([cd735e8](https://github.com/WayfarerLabs/agentworks/commit/cd735e8b617001ee74733f93b08cca4662c7847f))
* preserve Codex session persona names in overrides ([1d6455d](https://github.com/WayfarerLabs/agentworks/commit/1d6455d1b0b3b93183d709b02c9bfff5ddf9b031))
* preserve persisted artifact order and validate native inventories ([e9ecc2d](https://github.com/WayfarerLabs/agentworks/commit/e9ecc2dc4c2c21ded67d695d1b531f41b76b9119))
* preserve skill retirement retries and ordinary leftovers ([a64cda5](https://github.com/WayfarerLabs/agentworks/commit/a64cda5516d07cd7452ece66cec325960b1d7eec))
...
* recognize Claude bracketed artifact carrier help ([eb298fb](https://github.com/WayfarerLabs/agentworks/commit/eb298fbb6b0c3bf57e9dc8ab99b098857f4b07b3))
...
* report the actual inactive artifact route in inspection ([7288462](https://github.com/WayfarerLabs/agentworks/commit/7288462b6ba764b5e49d52719cdf181470efed9e))
* retain exact skill cleanup boundaries through retirement ([ad5a973](https://github.com/WayfarerLabs/agentworks/commit/ad5a9733a3eca40e027935c75f09cf0d7df21b39))
* retain external native homes for private session delivery ([955ea5f](https://github.com/WayfarerLabs/agentworks/commit/955ea5f9012885f52d34322c32f4caca08835308))
* route inactive VM artifacts through the user facet ([1c454f9](https://github.com/WayfarerLabs/agentworks/commit/1c454f9465c020ae8194eaf0477ff7fd5dd25b80))
* say what actually failed during VM initialization ([7c9905f](https://github.com/WayfarerLabs/agentworks/commit/7c9905fe4a435ee2999956a529b4f234e488ee4c))
* **schema:** allow unavailable integration opt-outs ([b1d8fe7](https://github.com/WayfarerLabs/agentworks/commit/b1d8fe72c6fea8df9e1c87f876f9064cb77c3cb2))
* **secrets:** correct 1Password approval order ([82b3402](https://github.com/WayfarerLabs/agentworks/commit/82b34024f5f3d4ef80d206003d39bd5b9d2fe382))
* **secrets:** correct 1Password approval order ([0f79f1d](https://github.com/WayfarerLabs/agentworks/commit/0f79f1dd408652d1acbd147159a2e8574c9f9444))
* **secrets:** improve 1Password timeout handling ([3742107](https://github.com/WayfarerLabs/agentworks/commit/3742107b6c02b7ff1e900f989f4d23eb19cda859))
* **secrets:** improve 1Password timeout handling ([4c96ce0](https://github.com/WayfarerLabs/agentworks/commit/4c96ce0397b85fa5c544855917c1ffce553d2440))
* **secrets:** keep generic deadline guidance neutral ([05b0802](https://github.com/WayfarerLabs/agentworks/commit/05b080211af70ad0b8ad6142965ef30f75bbca9d))
...
* share artifact revisions across VM and admin setup ([23dd85e](https://github.com/WayfarerLabs/agentworks/commit/23dd85e4787eb45bb06d99e5ba0d842af9cef16b))
...
* stream native inventory requests outside shell arguments ([14a4b13](https://github.com/WayfarerLabs/agentworks/commit/14a4b133686cf11ffde083adee52fc79e00ff0d6))
* validate artifact captures before persistence and native effects ([ebf68cc](https://github.com/WayfarerLabs/agentworks/commit/ebf68cc77b717e14114c85b5cd4e05c312fef6cd))
* **vm:** guarantee Python for native guest helpers ([2841cb9](https://github.com/WayfarerLabs/agentworks/commit/2841cb9fa9b21027961cb04a548e7ef70a66ae8c))
* **vm:** install Python for native guest helpers ([1b34544](https://github.com/WayfarerLabs/agentworks/commit/1b345445ecf1c75002bb960f2565ec59a27bbc51))
* **vms:** report dotfiles sync and install failures separately ([b5d8efa](https://github.com/WayfarerLabs/agentworks/commit/b5d8efa97f61629cb33fbed41cc1597bd4e3dbf1))


### Documentation

* align artifact contracts with user fallback routing ([dd0d962](https://github.com/WayfarerLabs/agentworks/commit/dd0d9629a824455d8f6199279b00d652f9f1caae))
* **artifacts:** bound elevated files to shared machine directories ([6959947](https://github.com/WayfarerLabs/agentworks/commit/695994730f54439ed6d382f000f7b6ebf4e35a18))
* **artifacts:** describe capture delivery and session identity contracts ([883cbf5](https://github.com/WayfarerLabs/agentworks/commit/883cbf587733de8be8be6af34e652d63f6fa42d0))
* **artifacts:** record authoring validation and completed review ([80019f3](https://github.com/WayfarerLabs/agentworks/commit/80019f3ee3cd6963a1779f8baf9621fc344991f5))
* **artifacts:** record implementation and private review dispositions ([acf7010](https://github.com/WayfarerLabs/agentworks/commit/acf7010bdee97bed5e68c7d030729180c718522d))
* **artifacts:** specify conservative session workarounds ([5a4bd84](https://github.com/WayfarerLabs/agentworks/commit/5a4bd847afdbe261c92beb319e0d711df0745702))
...
* explain deferred artifact refresh boundaries ([f20fecd](https://github.com/WayfarerLabs/agentworks/commit/f20fecd41455b701d7bc9ef5efe7323bf09b52db))
* guide scoped harness integration and artifact setup ([6bd3a34](https://github.com/WayfarerLabs/agentworks/commit/6bd3a3489c5f394dd38b4ac4911271160bfe9354))
...
* **harness:** retain session selectors and explain setup opt-outs ([788b1aa](https://github.com/WayfarerLabs/agentworks/commit/788b1aa9867a61eb6f923eda75fdb4a4179310db))
* **harness:** teach activation maps across resource scopes ([02cbfc8](https://github.com/WayfarerLabs/agentworks/commit/02cbfc8b77ae90e12791ca81480536f70f7c16f9))
...
* include artifact composition in the CLI guide ([2713b40](https://github.com/WayfarerLabs/agentworks/commit/2713b4092f719973d5aa5804bbafa07ffc562324))
* record native persona parsing and discovery evidence ([adb8646](https://github.com/WayfarerLabs/agentworks/commit/adb86461abd656e8efd1471456d6c5e1281196fe))
...
* **session:** clarify harness filter paths ([aa4a037](https://github.com/WayfarerLabs/agentworks/commit/aa4a0377118d2b2221780cd94e05ac98f97b6777))
* **session:** narrow registry fallback claim ([4f60241](https://github.com/WayfarerLabs/agentworks/commit/4f60241e170590a883d8d0c231e443300d8bf686))
