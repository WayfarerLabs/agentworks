...
* **config:** backends = ["env-var", "prompt"]
* **env:** Env entries no longer accept the retired mappings that include the unused source as null. Remove the null companion field in each manifest. Before: EDITOR: {value: vim, secret: null}. After: EDITOR: {value: vim}. Before: GITHUB_TOKEN: {value: null, secret: github-token}. After:
